...
#Une figure par run pour les métriques d'ordonnancement (3 tâches)
fig, (ax1, ax2) = subplots(2,1)
ax1.set_ylabel("temps d'exécution (ms)")
ax1.set_title("Performance d'ordonnancement essai 1 (haut) et 2 (bas)")
ax1.plot(try1["pas de simulation (ms)"]/1000, try1["orientation_cont last runtime"], color="#ff0000", label="orientation")
ax1.plot(try1["pas de simulation (ms)"]/1000, try1["orientation_cont worst runtime"], color="#850000", label="orientation (worst)")
ax1.plot(try1["pas de simulation (ms)"]/1000, try1["vitesse_cont last runtime"], color="#00ff00", label="vitesse")
ax1.plot(try1["pas de simulation (ms)"]/1000, try1["vitesse_cont worst runtime"], color="#008500", label="vitesse (worst)")
ax1.plot(try1["pas de simulation (ms)"]/1000, try1["batterie_cont last runtime"], color="#0000ff", label="batterie")
ax1.plot(try1["pas de simulation (ms)"]/1000, try1["batterie_cont worst runtime"], color="#000085", label="batterie (worst)")
ax1.grid()
ax2.set_ylabel("temps d'exécution (ms)")
ax2.set_xlabel('Temps depuis le début de la simulation (s)')
ax2.plot(try2["pas de simulation (ms)"]/1000, try2["orientation_cont last runtime"], color="#ff0000", label="orientation_cont")
ax2.plot(try2["pas de simulation (ms)"]/1000, try2["orientation_cont worst runtime"], color="#850000", label="orientation_cont (worst)")
ax2.plot(try2["pas de simulation (ms)"]/1000, try2["vitesse_cont last runtime"], color="#00ff00", label="vitesse_cont")
ax2.plot(try2["pas de simulation (ms)"]/1000, try2["vitesse_cont worst runtime"], color="#008500", label="vitesse_cont (worst)")
ax2.plot(try2["pas de simulation (ms)"]/1000, try2["batterie_cont last runtime"], color="#0000ff", label="batterie_cont")
ax2.plot(try2["pas de simulation (ms)"]/1000, try2["batterie_cont worst runtime"], color="#000085", label="batterie_cont (worst)")
ax2.grid()
ax2.legend(loc="best")
